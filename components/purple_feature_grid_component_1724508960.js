    ...
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container">
                <p id="feature-3-description" class="flex-1 text-sm">Discover our collection of sustainable, recycled, and bamboo toilet paper alternatives for the environmentally conscious.</p>
            </div>
        </div>
        ...
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container">
                    <h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">Auto-Replenishment</h4>
                </div>
            </div>
            <div class="flex" id="feature-4-description-container">
                <p id="feature-4-description" class="flex-1 text-sm">Never run out again with our smart subscription service that delivers toilet paper right to your door.</p>
            </div>
        </div>
        ...
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container">
                <p id="feature-5-description" class="flex-1 text-sm">Make informed decisions with our detailed product reviews and ratings from toilet paper connoisseurs.</p>
            </div>
        </div>
        ...
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container">
                <p id="feature-6-description" class="flex-1 text-sm">Find the best deals and compare prices across different brands and retailers to ensure you get the most value.</p>
            </div>
        </div>
    </div>
</template>
