...
<template>
  <footer id="footer-section-container">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 bg-gradient-to-br from-pink-400 to-purple-600 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg">
      <!-- Blocks -->
          ...
          <div class="h-full flex flex-col sm:flex-row lg:flex-col justify-between">
            <div id="footer-logo-copyright" class="mb-4 sm:mb-0">
              ...
              <div id="footer-copyright" class="text-sm text-white">
                © 2023 RollMart. All rights reserved.
                <span class="text-pink-200">-</span> Embracing the future of paper products.
              </div>
            </div>
            <!-- Social links -->
...
<script>
export default {
  name: "dark_footer_component_1724508960",
  data() {
    return {
      expanded: false,
      tab: null,
